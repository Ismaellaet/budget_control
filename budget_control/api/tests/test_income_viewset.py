...
class TestIncomeViewSet:
    ...
    def test_list_incomes(self, api_client, mock_incomes):
        response = api_client.get(reverse("income-list"))

        assert response.status_code == status.HTTP_200_OK

    def test_create_valid_income(self, api_client, income_data):
        response = api_client.post(path=reverse("income-list"), data=income_data)
    ...
    def test_retrieve_income(self, api_client):
        income = baker.make("Income")
        response = api_client.get(reverse("income-detail", args=[income.id]))
    ...
    def test_update_income(self, api_client):
        income = baker.make("Income")
    ...
    def test_delete_income(self, api_client):
        income = baker.make("Income")
        url = reverse("income-detail", args=[income.id])
    ...
    def test_get_incomes_by_year_month(self, api_client, mock_incomes):
        year, month = 2022, 3
